...
class HelperService {
    ...
    public static function getActivePaymentGateway(){
        try {
            $paymentMethodTypes = array('ecocash_status');
    ...
    public static function getActivePaymentDetails(){
        try {
            ...
            switch ($getActivePaymentName) {
                case 'ecocash_status':
                    $types = array('ecocash_status','ecocash_api_key','ecocash_mode','ecocash_currency','ecocash_reason');
                    $data = array('payment_method' => 'ecocash');
