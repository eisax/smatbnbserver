                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 mt-2">
                                        ...
                                        <input name="company_name" type="text" class="form-control" id="company_name" placeholder="{{ __('Company Name') }}" value="{{ isset($systemSettings['company_name']) && $systemSettings['company_name'] != '' ? $systemSettings['company_name'] : 'smatbnb' }}">
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 mt-2 form-group">
                                        ...
                                        <input name="unsplash_api_key" type="text" id="unsplash-api-key" class="form-control" placeholder="{{ __('Unsplash API Key') }}" value="{{ isset($systemSettings['unsplash_api_key']) && $systemSettings['unsplash_api_key'] != '' ? $systemSettings['unsplash_api_key'] : '' }}">
                                    </div>

                                    {{-- Place API Key --}}
                                    <div class="col-sm-12 col-md-6 mt-2 form-group">
                                        <label class="col-sm-12 form-label" for="place-api-key">{{ __('Place API Key') }}</label>
                                        <input name="place_api_key" type="text" id="place-api-key" class="form-control" placeholder="{{ __('Place API Key') }}" value="{{ isset($systemSettings['place_api_key']) && $systemSettings['place_api_key'] != '' ? $systemSettings['place_api_key'] : '' }}">
                                    </div>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-12 mt-2 p-4 row bg-light rounded" id="twilio-sms-settings-div" style="display: none">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4 mt-2 form-group mandatory">
                                    ...
                                    <input name="twilio_account_sid" type="text" class="form-control twilio-account-settings" id="twilio-account-sid" placeholder="{{ __('Account SID') }}" value="{{ isset($systemSettings['twilio_account_sid']) && $systemSettings['twilio_account_sid'] != '' ? $systemSettings['twilio_account_sid'] : '' }}">
                                </div>

                                {{-- Auth Token --}}
                                <div class="col-sm-12 col-md-6 col-lg-4 mt-2 form-group mandatory">
                                    <label class="col-sm-12 form-label" for="twilio-auth-token">{{ __('Auth Token') }}</label>
                                    <input name="twilio_auth_token" type="text" class="form-control twilio-account-settings" id="twilio-auth-token" placeholder="{{ __('Auth Token') }}" value="{{ isset($systemSettings['twilio_auth_token']) && $systemSettings['twilio_auth_token'] != '' ? $systemSettings['twilio_auth_token'] : '' }}">
                                </div>

                                {{-- My Twilio Phone Number --}}
                                <div class="col-sm-12 col-md-6 col-lg-4 mt-2 form-group mandatory">
                                    <label class="col-sm-12 form-label" for="twilio-my-phone-number">{{ __('My Twilio Phone Number') }}</label>
                                    <input name="twilio_my_phone_number" type="text" class="form-control twilio-account-settings" id="twilio-my-phone-number" placeholder="{{ __('My Twilio Phone Number') }}" value="{{ isset($systemSettings['twilio_my_phone_number']) && $systemSettings['twilio_my_phone_number'] != '' ? $systemSettings['twilio_my_phone_number'] : '' }}">
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="paypal_business_id" type="text" class="form-control" placeholder="{{ __('Paypal Business ID') }}" value="{{ isset($systemSettings['paypal_business_id']) && $systemSettings['paypal_business_id'] != '' ? $systemSettings['paypal_business_id'] : '' }}">
                        </div>

                        {{-- Paypal Webhook URL --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Paypal Webhook URL') }}</label>
                            <input name="paypal_webhook_url" type="text" class="form-control" placeholder="{{ __('Paypal Webhook URL') }}" value="{{ isset($systemSettings['paypal_webhook_url']) && $systemSettings['paypal_webhook_url'] != '' ? $systemSettings['paypal_webhook_url'] : '' }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="razor_key" type="text" class="form-control" placeholder="{{ __('Razorpay Key') }}" value="{{ isset($systemSettings['razor_key']) && $systemSettings['razor_key'] != '' ? $systemSettings['razor_key'] : '' }}">
                        </div>

                        {{-- Razorpay Webhook URL --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Razorpay Webhook URL') }}</label>
                            <input name="razorpay_webhook_url" type="text" class="form-control" placeholder="{{ __('Razorpay Webhook URL') }}" value="{{ isset($systemSettings['razorpay_webhook_url']) && $systemSettings['razorpay_webhook_url'] != '' ? $systemSettings['razorpay_webhook_url'] : '' }}">
                        </div>

                        {{-- Razorpay Secret --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Razorpay Secret') }}</label>
                            <input name="razor_secret" type="text" class="form-control" placeholder="{{ __('Razorpay Secret') }}" value="{{ isset($systemSettings['razor_secret']) && $systemSettings['razor_secret'] != '' ? $systemSettings['razor_secret'] : '' }}">
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="razor_webhook_secret" type="text" class="form-control" placeholder="{{ __('Razorpay Webhook Secret') }}" value="{{ isset($systemSettings['razor_webhook_secret']) && $systemSettings['razor_webhook_secret'] != '' ? $systemSettings['razor_webhook_secret'] : '' }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="paystack_secret_key" type="text" class="form-control" placeholder="{{ __('Paystack Secret Key') }}" value="{{ isset($systemSettings['paystack_secret_key']) && $systemSettings['paystack_secret_key'] != '' ? $systemSettings['paystack_secret_key'] : '' }}">
                        </div>

                        {{-- Paystack Webhook URL --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Paystack Webhook URL') }}</label>
                            <input name="paystack_webhook_url" type="text" class="form-control" placeholder="{{ __('Paystack Webhook URL') }}" value="{{ isset($systemSettings['paystack_webhook_url']) && $systemSettings['paystack_webhook_url'] != '' ? $systemSettings['paystack_webhook_url'] : '' }}">
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="paystack_public_key" type="text" class="form-control" placeholder="{{ __('Paystack Public Key') }}" value="{{ isset($systemSettings['paystack_public_key']) && $systemSettings['paystack_public_key'] != '' ? $systemSettings['paystack_public_key'] : '' }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="stripe_publishable_key" type="text" class="form-control" placeholder="{{ __('Stripe publishable key') }}" value="{{ isset($systemSettings['stripe_publishable_key']) && $systemSettings['stripe_publishable_key'] != '' ? $systemSettings['stripe_publishable_key'] : '' }}">
                        </div>

                        {{-- Stripe Webhook URL --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Stripe Webhook URL') }}</label>
                            <input name="stripe_webhook_url" type="text" class="form-control" placeholder="{{ __('Stripe Webhook URL') }}" value="{{ isset($systemSettings['stripe_webhook_url']) && $systemSettings['stripe_webhook_url'] != '' ? $systemSettings['stripe_webhook_url'] : '' }}">
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="stripe_secret_key" type="text" class="form-control" placeholder="{{ __('Stripe Secret key') }}" value="{{ isset($systemSettings['stripe_secret_key']) && $systemSettings['stripe_secret_key'] != '' ? $systemSettings['stripe_secret_key'] : '' }}">
                        </div>

                        {{-- Stripe Secret key --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-check-label-mandatory">{{ __('Stripe Webhook Secret key') }}</label>
                            <input name="stripe_webhook_secret_key" type="text" class="form-control" placeholder="{{ __('Stripe Webhook Secret key') }}" value="{{ isset($systemSettings['stripe_webhook_secret_key']) && $systemSettings['stripe_webhook_secret_key'] != '' ? $systemSettings['stripe_webhook_secret_key'] : '' }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="flutterwave_public_key" type="text" class="form-control" placeholder="{{ __('Public Key') }}" value="{{ isset($systemSettings['flutterwave_public_key']) && $systemSettings['flutterwave_public_key'] != '' ? $systemSettings['flutterwave_public_key'] : '' }}">
                        </div>

                        {{-- Secret Key --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Secret Key') }}</label>
                            <input name="flutterwave_secret_key" type="text" class="form-control" placeholder="{{ __('Secret Key') }}" value="{{ isset($systemSettings['flutterwave_secret_key']) && $systemSettings['flutterwave_secret_key'] != '' ? $systemSettings['flutterwave_secret_key'] : '' }}">
                        </div>

                        {{-- Encryption key --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Encryption Key') }}</label>
                            <input name="flutterwave_encryption_key" type="text" class="form-control" placeholder="{{ __('Encryption Key') }}" value="{{ isset($systemSettings['flutterwave_encryption_key']) && $systemSettings['flutterwave_encryption_key'] != '' ? $systemSettings['flutterwave_encryption_key'] : '' }}">
                        </div>

                        {{-- Flutterwave Webhook URL --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Flutterwave Webhook URL') }}</label>
                                <input name="flutterwave_webhook_url" type="text" class="form-control" placeholder="{{ __('Flutterwave Webhook URL') }}" value="{{ isset($systemSettings['flutterwave_webhook_url']) && $systemSettings['flutterwave_webhook_url'] != '' ? $systemSettings['flutterwave_webhook_url'] : '' }}">
                        </div>
                    ...
                    {{-- Ecocash Setting --}}
                    <div class="divider pt-3 mt-3">
                        <h6 class="divider-text">{{ __('Ecocash Setting') }}</h6>
                    </div>
                    <div class="form-group row">
                        {{-- API Key --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Ecocash API Key') }}</label>
                            <input name="ecocash_api_key" type="text" class="form-control" placeholder="{{ __('Ecocash API Key') }}" value="{{ isset($systemSettings['ecocash_api_key']) && $systemSettings['ecocash_api_key'] != '' ? $systemSettings['ecocash_api_key'] : '' }}">
                        </div>
                        {{-- Mode --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Mode') }}</label>
                            <select name="ecocash_mode" id="ecocash_mode" class="choosen-select form-select form-control-sm">
                                <option value="sandbox" {{ isset($systemSettings['ecocash_mode']) && $systemSettings['ecocash_mode'] == 'sandbox' ? 'selected' : '' }}>{{ __('Sandbox') }}</option>
                                <option value="live" {{ isset($systemSettings['ecocash_mode']) && $systemSettings['ecocash_mode'] == 'live' ? 'selected' : '' }}>{{ __('Live') }}</option>
                            </select>
                        </div>
                        {{-- Currency --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Currency') }}</label>
                            <input name="ecocash_currency" type="text" class="form-control" placeholder="{{ __('Currency (e.g. USD)') }}" value="{{ isset($systemSettings['ecocash_currency']) && $systemSettings['ecocash_currency'] != '' ? $systemSettings['ecocash_currency'] : 'USD' }}">
                        </div>
                        {{-- Reason --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Reason') }}</label>
                            <input name="ecocash_reason" type="text" class="form-control" placeholder="{{ __('Payment Reason') }}" value="{{ isset($systemSettings['ecocash_reason']) && $systemSettings['ecocash_reason'] != '' ? $systemSettings['ecocash_reason'] : 'Payment' }}">
                        </div>
                        {{-- Status --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-check-label" id='lbl_ecocash'>{{ __('Enable') }}</label>
                            <div>
                                <div class="form-check form-switch">
                                    <input type="hidden" name="ecocash_status" id="ecocash_status" value="{{ isset($systemSettings['ecocash_status']) && $systemSettings['ecocash_status'] != '' ? $systemSettings['ecocash_status'] : 0 }}">
                                    <input class="form-check-input" type="checkbox" role="switch" class="switch-input" name='op' {{ isset($systemSettings['ecocash_status']) && $systemSettings['ecocash_status'] == '1' ? 'checked' : '' }} id="switch_ecocash_status">
                                    <label class="form-check-label" for="switch_ecocash_status"></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class=" form-control" name="schema_for_deeplink" id="schema" value="{{ isset($systemSettings['schema_for_deeplink']) && $systemSettings['schema_for_deeplink'] != '' ? $systemSettings['schema_for_deeplink'] : '' }}" placeholder="{{ __('Your Schema') }}">
                                <small class="text-grey">{{ __('Note: Please add your scheme here using a single word in lowercase (e.g., smatbnb).') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
                ...
                if (event.target.checked) {
                    checkboxes.forEach((checkbox) => {
                        if (checkbox !== event.target) {
                            ...
                            $("#switch_ecocash_status").is(':checked') ? $("#ecocash_status").val(1) : $("#ecocash_status").val(0);
                        }
                    });
                }
            });
        ...
        $("#switch_ecocash_status").on('change', function() {
            $("#switch_ecocash_status").is(':checked') ? $("#ecocash_status").val(1) : $("#ecocash_status").val(0);
        });
