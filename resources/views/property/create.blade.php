    ...
    <div class='row'>
        <div class='col-md-6'>
            <div class="card">
                ...
                <hr>
                <input type="hidden" id="default-latitude" value="{{ system_setting('latitude') ?? -17.8252 }}">
                <input type="hidden" id="default-longitude" value="{{ system_setting('longitude') ?? 31.0335 }}">
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // initialize form fields with default coordinates from hidden inputs
            var dLat = parseFloat($('#default-latitude').val()) || -17.8252;
            var dLng = parseFloat($('#default-longitude').val()) || 31.0335;
            $('#latitude').val(dLat);
            $('#longitude').val(dLng);
        ...
        jQuery(document).ready(function() {
            ...
            $('#map').append('<iframe src="https://maps.google.com/maps?q=' + (-17.8252) + ',' + (31.0335) +
        ...
        function initMap() {
            let defaultLatitude = parseFloat($("#default-latitude").val()) || -17.8252;
            let defaultLongitude = parseFloat($("#default-longitude").val()) || 31.0335;
            ...
            // set defaults to inputs on init
