...
class ApiController extends Controller
{
    ...
    {
        $payment_settings = Setting::select('type', 'data')->whereIn('type', [
    ...
    public function getPaymentIntent(Request $request) {
        ...
        try {
            ...
            $paymentIntent = PaymentService::create($paymentSettings)->createAndFormatPaymentIntent(round($package->price, 2), [
                ...
                'customer_msisdn'        => Auth::user()->mobile ?? "",
            ]);
    ...
    public function deepLink(Request $request){
        try{
            ...
            $appName = $data['company_name'] ?? 'smatbnb';
            $customerPlayStoreUrl = $data['playstore_id'] ?? 'https://play.google.com/store/apps/details?id=com.smatbnb.smatbnb';
